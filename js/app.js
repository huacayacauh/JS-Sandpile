...
function drawTiling(){
	...
	var trou = document.getElementById("trou").value;

	var q = document.getElementById("sommet").value;

	var command = "currentTiling = Tiling." + preset +
	"({height:cH, width:cW, iterations:nbIt, size:size, cote:p, sommet:q, trou:trou})";
