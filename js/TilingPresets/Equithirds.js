...
//
// [1] define tile types triangle
//

// equi
var bounds = [];
bounds.push(0, 0); // left
bounds.push(1, 0); // right
bounds.push(0.5, sqrt3/2); // up
var equi = new Tile(['equi'],[],bounds,3);

// iso
var bounds = [];
bounds.push(0, 0); // left
bounds.push(sqrt3, 0); //right
bounds.push(sqrt3/2, 0.5); // up
...
//
// [2] define substitution equithirds
//
