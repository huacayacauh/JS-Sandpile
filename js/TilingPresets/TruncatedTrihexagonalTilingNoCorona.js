                ...
                for (var z = -radius; z <= radius; z++) {
                    if (x + y + z == 0) {
                        ...
                        if (x == radius) {
                            // Upper right corner
                            if (z == -radius){
                                tils = tils.concat(upRightCorner(x, y, z, size));
                            }

                            // Lower right corner
                            else if (y == -radius){
                                tils = tils.concat(downRightCorner(x, y, z, size));
                            }

                            else{
                                tils = tils.concat(rightSide(x, y, z, size));
                            }
                        }
                        ...
                        // Left side
                            ...
                            // Upper left corner
                            if (y == radius){
                                tils = tils.concat(upLeftCorner(x, y, z, size));
                            }

                            // Lower left corner
                            else if (z == radius){
                                tils = tils.concat(downLeftCorner(x, y, z, size));
                            }
                            
                            else{
                                tils = tils.concat(leftSide(x, y, z, size));
                            }
                        }
                        ...
                        // Upper left side
                            ...
                            // Upper corner
                            if (z == -radius){
                                tils = tils.concat(upCorner(x, y, z, size));
                            }
                            
                            else{
                                tils = tils.concat(upLeftSide(x, y, z, size));
                            }
                        }
                        ...
                        // Lower right side
                            ...
                            // Lower corner
                            if (z == radius){
                                tils = tils.concat(downCorner(x, y, z, size));
                            }
                            
                            else{
                                tils = tils.concat(downRightSide(x, y, z, size));
                            }
                        }
                        
                        // Lower left side
                        else if (z == radius) {
                            tils = tils.concat(downLeftSide(x, y, z, size))
                        }

                        // Upper right side
                        else if (z == -radius) {
                            tils = tils.concat(upRightSide(x, y, z, size))
                        }
...
function upRightCorner(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(squareTile(x, y, z, 1));
        tils.push(hexagonTile(x, y, z, 2));
...
function downRightCorner(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(hexagonTile(x, y, z, 2));
        tils.push(squareTile(x, y, z, 3));
...
function downCorner(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(hexagonTile(x, y, z, 4));
        tils.push(squareTile(x, y, z, 5));
...
function downLeftCorner(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(hexagonTile(x, y, z, 6));
        tils.push(squareTile(x, y, z, 7));
...
function upLeftCorner(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(squareTile(x, y, z, 1));
        tils.push(hexagonTile(x, y, z, 8));
...
function upRightSide(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(squareTile(x, y, z, 1));
        tils.push(hexagonTile(x, y, z, 2));
...
function downRightSide(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(hexagonTile(x, y, z, 4));
        tils.push(squareTile(x, y, z, 5));
...
function downLeftSide(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(hexagonTile(x, y, z, 6));
        tils.push(squareTile(x, y, z, 7));
...
function upLeftSide(x, y, z, size){
    tils = [];
    if(!(Math.abs(x) == size || Math.abs(y) == size || Math.abs(z) == size)){
        tils.push(squareTile(x, y, z, 1));
        tils.push(hexagonTile(x, y, z, 10));
